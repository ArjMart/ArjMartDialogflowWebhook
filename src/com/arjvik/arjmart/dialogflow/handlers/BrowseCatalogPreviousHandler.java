...
public class BrowseCatalogPreviousHandler extends AbstractBrowseCatalogHandler implements IntentFulfillmentHandler {
	...
	public WebhookResponse handle(WebhookRequest request) {
		...
		return browseCatalogWithOffset(request, offset, "BrowseCatalogPrevious");
	}
