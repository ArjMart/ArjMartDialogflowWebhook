...
public class SearchCatalogNextHandler extends AbstractSearchCatalogHandler implements IntentFulfillmentHandler {
	...
	public WebhookResponse handle(WebhookRequest request) {
		...
		return searchCatalogWithOffset(request, query, offset, "SearchCatalogNext");
	}
